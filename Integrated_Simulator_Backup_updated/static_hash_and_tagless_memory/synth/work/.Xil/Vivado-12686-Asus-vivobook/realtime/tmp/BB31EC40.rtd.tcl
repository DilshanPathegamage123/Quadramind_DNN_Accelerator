...
set genomeRtd $env(RT_TMP)/BB31EC40.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {scratchpad_ram__GB9}]"
...
set genomeName [subst -nocommands -novariables {scratchpad_ram__GB9}]
