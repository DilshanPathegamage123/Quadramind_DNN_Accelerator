...
set genomeRtd $env(RT_TMP)/964564A0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__5126_scratchpad_ram}]"
...
set genomeName [subst -nocommands -novariables {muxpart__5126_scratchpad_ram}]
