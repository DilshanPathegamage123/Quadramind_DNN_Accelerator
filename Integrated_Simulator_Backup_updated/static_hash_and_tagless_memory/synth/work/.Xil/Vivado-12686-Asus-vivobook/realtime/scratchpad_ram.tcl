...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-12686-Asus-vivobook/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv -include /FYP_Vivado/2025.2/data/rsb/busdef /home/lahiruni/Downloads/Quadramind_DNN_Accelerator-fix-chooser-accuracy/Integrated_Simulator_Backup_updated/sim_framework/rtl/memory/scratchpad_ram.sv
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification false
    set rt::top scratchpad_ram
...
# MODE: out_of_context
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-12686-Asus-vivobook/"
