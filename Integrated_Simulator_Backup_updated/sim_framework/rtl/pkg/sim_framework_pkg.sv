...
package sim_framework_pkg;
    ...
    //-------------------------------------------------------------------------
    localparam logic [4:0] SCHEDSEL_FIFO        = 5'd0;
    localparam logic [4:0] SCHEDSEL_LIFO        = 5'd1;
    localparam logic [4:0] SCHEDSEL_SJF         = 5'd2;
    localparam logic [4:0] SCHEDSEL_RR          = 5'd3;
    localparam logic [4:0] SCHEDSEL_PRI         = 5'd4;
    localparam logic [4:0] SCHEDSEL_EDF         = 5'd5;
    localparam logic [4:0] SCHEDSEL_LRU         = 5'd6;
    localparam logic [4:0] SCHEDSEL_SRTF        = 5'd7;
    localparam logic [4:0] SCHEDSEL_HRRN        = 5'd8;
    localparam logic [4:0] SCHEDSEL_MLQ         = 5'd9;
    localparam logic [4:0] SCHEDSEL_MLFQ        = 5'd10;
    localparam logic [4:0] SCHEDSEL_AIMT        = 5'd11;
    localparam logic [4:0] SCHEDSEL_BATCHDNN    = 5'd12;
    localparam logic [4:0] SCHEDSEL_BATCHDNNPP  = 5'd13;
