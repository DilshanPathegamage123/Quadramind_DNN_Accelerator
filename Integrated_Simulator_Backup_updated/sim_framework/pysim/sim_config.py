...
class SimConfig:
    ...
    # num_banks: number of interleaved SRAM banks in the scratchpad.
    #   1  = flat/single-bank array; no bank conflicts (use as baseline).
    #   ≥2 = low-order address bits select the bank (standard interleaved).
    #   Must be a power of two.  Default 4 models a typical 4-bank SRAM macro.
    #   Sweep this knob alongside dataflow, mem_layout, and memory backend
    #   for Experiment Set 4 (bank conflict & memory-stall characterisation).
    num_banks: int = 4
    ...
    def cocotb_env(self) -> dict:
        ...
        return {
            ...
            "SIM_NUM_BANKS":   str(self.num_banks),
        }
